...
public final class PowerComputer {
     ...
     * previous batch at the same position. This allows us to always have the eight values that interest us in the
     * same table. It does not matter if they are not in order since a sum commutative.
