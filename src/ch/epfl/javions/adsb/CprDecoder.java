...
public class CprDecoder {
    ...
    public static GeoPos decodePosition(double x0, double y0, double x1, double y1, int mostRecent) {
        ...
        int latitude0T32 = (int) Units.convert(latitudeTurn0, Units.Angle.TURN, Units.Angle.T32);
        int latitude1T32 = (int) Units.convert(latitudeTurn1, Units.Angle.TURN, Units.Angle.T32);
        ...
        int longitudeT32 = (int) Units.convert(longitudeTurn, Units.Angle.TURN, Units.Angle.T32);
